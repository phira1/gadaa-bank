...
export const departments = [
  ...
  { name: 'Account Opening', email: 'accounts@gadaabank.com.et', phone: 'xxx' },
  { name: 'Loan Department', email: 'loans@gadaabank.com.et', phone: 'xxx' },
  { name: 'Card Services', email: 'cards@gadaabank.com.et', phone: 'xxx' }
];
