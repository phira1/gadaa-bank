export const searchableContent = [
  ...
  { title: 'Diaspora & FCY Products', path: '/services/diaspora-fcy-products', category: 'International Banking', description: 'Foreign currency products for diaspora' },
  { title: 'Correspondent Accounts', path: '/services/correspondent-accounts', category: 'International Banking', description: 'Bank-to-bank relationships' },
  ...
  // Community Banking
  { title: 'Community Banking', path: '/community', category: 'Community', description: 'Banking services tailored for communities' },
