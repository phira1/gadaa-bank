      ...
      >
        <div className="container mx-auto px-4 relative z-10">
          <nav className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-red-500">›</span>
            <span className="text-white font-semibold">Business Loans</span>
          </nav>
        </div>
        <motion.div 
        ...
        >
          ...
          >
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 shadow-xl border border-gray-200">
              ...
              <p className="text-gray-700 leading-relaxed">
                Gadaa Bank is developing comprehensive business loan solutions to support entrepreneurs 
                and businesses of all sizes. Our upcoming offerings will provide flexible financing 
                options for working capital, expansion, equipment purchase, and more, with competitive 
                terms designed to fuel your business growth.
              </p>
              <motion.div 
              ...
              >
                <p className="text-blue-800 font-medium flex items-center">
                  ...
                  Detailed business loan information will be available soon. Please check back later or contact us for updates.
                </p>
              </motion.div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="mt-16 mb-12">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">
              Estimate Your <span className="text-red-600">Business Loan Payments</span>
            </h2>
            <LoanCalculator />
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              >
                Contact our business loan specialists to discuss your financing needs
              </motion.p>
              ...
              >
                {[
                  ...
                  { icon: FaEnvelope, title: 'Email', desc: 'businessloans@gadaabank.com' },
                  { icon: FaPhoneAlt, title: 'Business Loan Support', desc: 'Contact for details' } // Updated label
                ].map((contact, index) => (
                  <motion.div
                    key={index}
