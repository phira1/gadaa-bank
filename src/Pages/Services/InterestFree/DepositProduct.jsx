  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-gray-50 to-white" ref={sectionRef}>
      ...
      <div className="relative w-full h-[40vh] md:h-[50vh] overflow-hidden">
        {/* Background Image - Updated to depositproduct.jpg */}
        <img
          ...
          <div className="max-w-6xl mx-auto w-full">
            <div className="max-w-xl">
              ...
              <p className="text-xl md:text-2xl text-white/90 font-light leading-relaxed">
                Interest Free Banking • GADAA Al Rayyan
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
          ...
          {/* Products Grid - Clean Simple Cards */}
          <motion.div 
            ref={productsRef}
            variants={itemVariants} 
            className="mb-12"
              ...
              {depositProducts.map((product, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`product-card p-4 cursor-pointer transition-all duration-300 hover:bg-gray-50 rounded-lg ${
                  ...
                  >
                    <div className="flex flex-col">
                      <div className="flex items-start mb-3">
                        <motion.div 
                          className="w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center mr-3 md:mr-4 bg-gradient-to-br from-red-50 to-red-100 flex-shrink-0"
                        ...
                        <div>
                          <h3 className="text-base md:text-lg font-bold text-gray-900 mb-1 line-clamp-1">{product.name}</h3>
            ...
            >
              <div className="flex items-center mb-8">
                {(() => {
                  ...
                  return (
                    <motion.div 
                      className="w-16 h-16 rounded-full flex items-center justify-center mr-6 bg-gradient-to-br from-red-50 to-red-100"
                ...
                <div>
                  <h3 className="text-2xl font-bold mb-2 text-gray-900">{depositProducts[activeProduct].name}</h3>
                  <p className="text-gray-600">{depositProducts[activeProduct].description}</p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-700">Completely interest-free banking</span>
                    </li>
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-red-500 rounded-full mr-3"></div>
                      <span className="text-gray-700">Sharia Advisory Board approved</span>
                    </li>
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-red-500 rounded-full mr-3"></div>
                      <span className="text-gray-700">Ethical and transparent practices</span>
                    </li>
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-red-500 rounded-full mr-3"></div>
                      <span className="text-gray-700">Profit-sharing opportunities</span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-700">Visit any Gadaa Bank branch</span>
                    </li>
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-gray-900 rounded-full mr-3"></div>
                      <span className="text-gray-700">Valid ID or passport required</span>
                    </li>
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-gray-900 rounded-full mr-3"></div>
                      <span className="text-gray-700">Minimum deposit applies</span>
                    </li>
                    <li className="flex items-center">
                      <div className="w-2 h-2 bg-gray-900 rounded-full mr-3"></div>
                      <span className="text-gray-700">Sign Sharia compliance agreement</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          >
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              >
                <FaStar className="text-white text-2xl sm:text-3xl" />
              </motion.div>
              ...
              <motion.p 
                ...
                transition={{ delay: 0.3 }}
              >
                Join thousands who have chosen ethical banking with Gadaa Bank Al Rayyan
              </motion.p>
              ...
              >
                {[
                  { icon: FaPhoneAlt, title: 'Islamic Banking Desk', desc: '+251-XXX-ALRAYAN' },
                  { icon: FaEnvelope, title: 'Email', desc: 'alrayyan@gadaabank.com' },
